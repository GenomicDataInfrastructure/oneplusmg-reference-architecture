...
- **Context:** GDPR constraints (L01/L02) prohibit moving sensitive genomic data out of national jurisdictions to a central cloud.
...
- **Decision:** All compute interfaces (WES) must be **Asynchronous**. Users submit a jobID and poll for status.
