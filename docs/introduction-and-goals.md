...
- **Ensure Data Sovereignty:** The system must adhere to a federated model where data remains within the jurisdiction of the Member State (National Nodes), respecting local ethical and legal frameworks while enabling cross-border analysis.[^3]
- **Sustainable Operation:** The transition from project-based funding (GDI) to the Genome European Digital Infrastructure Consortium (Genome EDIC) requires a cost-effective, sustainable infrastructure model funded by Member States.[^4] [^5] [^15]
- **Trust and Social Acceptance:** The architecture must enforce a robust Trust Framework to maintain public trust in genomic data sharing, ensuring that citizens' data is handled securely and ethically.[^6]
...
| --- | ------------------ | --------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| QG1 | Interoperability   | The ability of diverse national systems to exchange data and compute instructions using open standards (GA4GH, FHIR). | Essential to overcome the fragmentation of different national healthcare systems and tech stacks.[^8]                                              |
| QG2 | Security & Privacy | Strict adherence to GDPR and national regulations, implementing "Privacy by Design" and "Zero Trust" principles.      | A single breach could undermine the entire political initiative. Compliance with the emerging European Health Data Space (EHDS) is mandatory.[^14] |
| QG3 | Scalability        | The capacity to handle petabytes of genomic data and high-throughput analysis requests.                               | The system must scale from current pilots to >1 million genomes without performance degradation.[^3] [^4] [^7] [^15]                               |
| QG4 | Transparency       | Visibility into how data is used and processed.                                                                       | Required for auditing and to maintain the trust of data subjects (citizens). [^16]                                                                 |
| QG5 | Usability          | Streamlined user journeys for researchers and clinicians.                                                             | Reducing the administrative burden of finding data and applying for access (DACs) is key to system uptake.[^9]                                     |
...
[^3]: GDI Deliverable D6.3 - Report on requirements for data quality and distributed analysis, as well as external resource interoperability. (https://zenodo.org/records/13920170)
...
[^7]: GDI Deliverable D6.6 - Report outlining the recommendations on data curation and ELSI compliance. (https://zenodo.org/records/10723494)

[^8]: GDI Deliverable D8.7 - Report on semantic interoperability scenarios. (https://zenodo.org/records/11550316)

[^9]: B1MG Deliverable D2.4 - Report on data access and governance framework. (https://zenodo.org/records/8411102)

[^10]: GDI Deliverable D8.8 - Evaluation of distributed analysis and federated learning infrastructure solutions and recommendations for adoption (https://zenodo.org/records/10887366)

[^11]: GDI Deliverable D8.5 - Report on federated learning technologies (https://zenodo.org/records/11550561)

[^12]: GDI Deliverable D3.8 - Feedback on the recommendation of infrastructure solutions for distributed analysis and federated learning (https://zenodo.org/records/15366621)

[^13]: B1MG Deliverable D3.8 - Documented best practices in sharing and linking phenotypic and genetic data —2v0. (https://zenodo.org/records/7342855)

[^14]: GDI Deliverable D6.1 - Draft data management policy published including ELSI best practice (https://zenodo.org/records/7956612)

[^15]: GDI Deliverable D2.1 - First analysis of cost elements for the setup of 1+MG infrastructure. (https://zenodo.org/records/10728049)

[^16]: 1+MG Transparency and Consent Guidance - version for 1+MG Framework (https://zenodo.org/records/8279851)

[^17]: GDI Deliverable D2.9 - Evaluation of data governance experiences - Report. (https://zenodo.org/records/10069814)

[^18]: 1+MG Use cases. (https://framework.onemilliongenomes.eu/usecases)
